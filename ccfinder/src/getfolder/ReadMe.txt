========================================================================
    コンソール アプリケーション : getfolder プロジェクトの概要
========================================================================

AppWizard はユーザー用に getfolder アプリケーションを作成しました。  
このファイルには getfolder アプリケーションを構成している
各ファイルの概要が含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル getfolder.pch、
